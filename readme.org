...
and is exported to ~readme.org~ with =,eOo= to render in the githup repo.
You can find an export HTML version of it here: https://lccambiaghi.github.io/.doom.d/readme.html
